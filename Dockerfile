...
# Default 90000 — an unset ARG becomes "" and Next inlines Number("") === 0
# (instant profile "Request timed out") unless code skips empty strings.
ARG NEXT_PUBLIC_PROFILE_FETCH_TIMEOUT_MS=90000
